...
1. Unzip and rename the template directory (`unzip ~/Downloads/react-project-ecommmerce-master.zip`).
1. Move into the new project and `git init`.
1. Empty [`README.md`](README.md) and fill with your own content.
1. Replace `react-project-ecommmerce` in `package.json` with your
   projects name.
